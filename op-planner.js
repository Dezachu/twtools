...
/*==== updated by Dezachu 29th Mar 2023 ====*/
    ...
    try {
        ...
        function fnGenerateOp() {
            ...
            for (i = 0; i < table.tBodies[0].rows.length; i++) {
                ...
                var numCols = table.tBodies[0].rows[0].cells.length;
                var cod = fnGetText(table.tBodies[0].rows[i].cells[numCols == 4 ? 2 : 1]);
                var pint = fnGetText(table.tBodies[0].rows[i].cells[numCols == 4 ? 3 : 2]);
                coords[i - 1] = cod;
