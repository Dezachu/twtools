...
var translations = {
    ...
    tr_TR: {
        'Incomings Overview': 'Incomings Overview',
        Help: 'Destek',
        'It seems like you have no incomings ': 'HiÃ§ gelen yok gibi gÃ¶rÃ¼nÃ¼yor ',
        'Total Incomings:': 'Toplam gelenler:',
        'Attacking Players:': 'SaldÄ±ran Oyuncular:',
        'Total Attacking Players:': 'Toplam SaldÄ±ran Oyuncular:',
        'Destination Villages Count:': 'Hedef KÃ¶y SayÄ±sÄ±:',
        'Origin Villages Count:': 'Kaynak KÃ¶y SayÄ±sÄ±:',
        'Destination Villages': 'Hedef KÃ¶yler',
        'Origin Villages': 'Kaynak KÃ¶yler',
        'Export Incomings Data': 'Gelen Verilerini DÄ±ÅŸa Aktar',
        'Highlight Possible Nobles': 'OlasÄ± Misyonerleri VurgulayÄ±n',
        Village: 'KÃ¶y',
        Count: 'Say',
        'Toggle Combinations': 'KombinasyonlarÄ± DeÄŸiÅŸtir',
        'Possible nobles are highlighted!': 'OlasÄ± misyonerler vurgulanÄ±r!',
        'No possible nobles were found!': 'OlasÄ± misyoner bulunamadÄ±!',
        Watchtower: 'GÃ¶zetleme Kulesi',
        'Attack:': 'SaldÄ±rÄ±    :',
        'Small Attack:': 'KÃ¼Ã§Ã¼k SaldÄ±rÄ±:',
        'Medium Attack:': 'Orta SaldÄ±rÄ±:',
        'Large Attack:': 'BÃ¼yÃ¼k SaldÄ±rÄ±:',
        'Contains Nobleman:': 'Misyoner Ä°Ã§erir:',
        'Destination Villages List': 'Gidilecek KÃ¶yler Listesi',
        'Destination Villages Coords': 'Hedef KÃ¶yler KoordinatlarÄ±',
        'Origin Villages List': 'Kaynak KÃ¶y Listesi',
        'Origin Villages Coords': 'Kaynak KÃ¶y KoordinatlarÄ±',
        'Last updated at:': 'Son gÃ¼ncelleme:',
        'Mass Tag Incomings': 'Gelenleri Toplu Etiket',
        'Tagging incomings ...': 'Gelenler Etiketleniyor ...',
        'Watchtower Timer': 'GÃ¶zetleme Kulesi ZamanÄ±',
        'Watchtower Timer script initialized ...':
            'GÃ¶zetleme Kulesi zamanlayÄ±cÄ± scripti baÅŸlatÄ±ldÄ± ...',
        'Current world does not support watchtower!':
            'Bu dÃ¼nya gÃ¶zetleme kulesini desteklemiyor!',
        'Watchtower Timer script is already initialized!':
            'GÃ¶zetleme kulesi zamanlayÄ±cÄ± scripti zaten baÅŸlatÄ±ldÄ±',
        'Create New Forum Thread': 'Yeni Forum Konusu OluÅŸtur',
        'Create New Mail': 'Yeni Posta OluÅŸtur',
        Overview: 'Genel bakÄ±ÅŸ',
        Map: 'Harita',
        Fetch: 'Getir',
        'Village data could not be fetched!': 'KÃ¶y verileri getirilemedi!',
        Support: 'Destek',
        'OP Spotter': 'OP Spotter',
        'Landing Time': 'VarÄ±ÅŸ ZamanÄ±',
        'Own Villages Info': 'Kendi KÃ¶y Bilgileri',
        'Own Villages': 'Kendi KÃ¶yleri',
        'Enemy Villages': 'DÃ¼ÅŸman KÃ¶yleri',
        'Redirecting to Incomings page...':
            'Gelenler sayfasÄ±na yÃ¶nlendiriliyor...',
        'There was an error parsing the incomings list!':
            'Gelenler listesi ayrÄ±ÅŸtÄ±rÄ±lÄ±rken bir hata oluÅŸtu!',
        'Fake Finder': 'Fake Bulucu',
        'Find Fakes': 'Fake Bul',
        'Fakes where found!': 'Fakes bulundu!',
        'No fakes where found!': 'Fake bulundmadÄ±!',
        'Add Backtime': 'Geri dÃ¶nÃ¼ÅŸ ekle',
        'Backtime was added on incoming label!':
            'Gelen etikete geri dÃ¶nÃ¼ÅŸ sÃ¼resi eklendi!',
        'All incomings have backtime already added!':
            'TÃ¼m gelenlere zaten geri dÃ¶nÃ¼ÅŸ sÃ¼resi eklenmiÅŸ!',
        'Tag incomings before adding backtimes!':
            'Geri dÃ¶nÃ¼ÅŸ eklemeden Ã¶nce gelenleri etiketleyin!',
    },
};
